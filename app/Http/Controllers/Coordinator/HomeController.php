...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('lecturers.coordinator.home', compact('count_classes', 'count_subjects','count_rooms', 'count_lecturers'));
    }
    public function notify(){
        $class = Classes::all();
        return view('lecturers.coordinator.notify', ['classes'=>$class]);
    }
