...
<body>
    ...
    <section class="body-sign">
        <div class="center-sign">
            <a href="/" class="logo pull-left">
                <img src="assets/images/logo2.png" height="54" alt="Porto Admin" />
            </a>
                        ...
                        <div class="form-group mb-lg">
                            ...
                            <div class="input-group input-group-icon">
                                <input id="login_id" type="text"
                                    ...
                                    name="login_id" value="{{ old('login_id') }}" required autocomplete="login_id"
                                    autofocus />
    ...
    <script src="assets/vendor/jquery-browser-mobile/jquery.browser.mobile.js"></script>alert-primary
